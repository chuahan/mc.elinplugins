...
{
    public static bool IsBefriendedThroughDialog => player.dialogFlags.TryGetValue("niyonRecruited") > 0;
    ...
    public void _OnBarter()
    {
        ...
        player.dialogFlags.TryGetValue("niyonRepairComplete", out int niyonRepairComplete);
        ...
        player.dialogFlags.TryGetValue("niyonAwakened", out int niyonSelenaCollabComplete);
        ...
        player.dialogFlags.TryGetValue("niyonAwakened", out int niyonAwakened);
        if (niyonAwakened > 0)
        {
        ...
        player.dialogFlags.TryGetValue("selenaAwakened", out int selenaAwakened);
        if (selenaAwakened > 0)
        {
