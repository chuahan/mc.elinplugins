...
public class SpElementalCannon : Spell
{
    ...
    public override bool Perform()
    {
        ...
        ElementRef elementRef = setting.elements[_source.aliasRef];
        ...
        Element element = Element.Create(cannonSpell.aliasEle, GetPower(CC) / 10);
        List<Point> targetArea = _map.ListPointsInCircle(TC.pos, 5, false, false);
        ActEffect.DamageEle(CC, EffectId.Ball, GetPower(CC), element, targetArea, cannonSpell, "spell_ball");
        return true;
    }
}