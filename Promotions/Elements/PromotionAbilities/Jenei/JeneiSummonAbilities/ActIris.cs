...
public class ActIris : ActJeneiSummonSequence
{
    ...
    public override bool Perform()
    {
        ...
        {
            List<KeyValuePair<int, Chara>> deadAllies = game.cards.globalCharas.Where(c => c.Value.isDead && c.Value.faction == pc.faction && !c.Value.isSummon && c.Value.c_wasInPcParty)
                    .ToList();
