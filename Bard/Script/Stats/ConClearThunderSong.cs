            ...
            if (selectedCharas.Count > 0)
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    if (Stacks == 1)
                    {
                        ...
                        HelperFunctions.DamageHpWrapper(target, boostedDamage, Constants.EleLightning, 100, AttackSource.Condition, owner);
                        /*
                    ...
                    {
                        HelperFunctions.DamageHpWrapper(target, damage, Constants.EleLightning, 100, AttackSource.Condition, owner);
                        /*
