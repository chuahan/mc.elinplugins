...
/// The target is spawned in a target town along with a group of guards. They will have a debuff that prevents them from dying.
...
public class QuestCovertOpAbduct : Quest
{
    ...
    public override void OnStart()
    {
        ...
        if (EClass.pc.things.Find("sword_bokuto") == null)
        {
            Thing standardIssueBokuto = ThingGen.Create("sword_bokuto", lv:scaledLevel);
            EClass.pc.things.Add(standardIssueBokuto);
        }
        
        // Provide the player with the snagball.
        EClass.pc.things.Add(ThingGen.Create("snagball", lv:scaledLevel));
    }
